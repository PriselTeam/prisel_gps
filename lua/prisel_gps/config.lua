Prisel.GPS.Config = Prisel.GPS.Config or {}

Prisel.GPS.Config.Coords = {
    {
    ...
    {
        coords = Vector(-13799.000000, 12334.712891, 576.031250),
        label = "Hangar jaune hors ville",
        prefix = "du"
    },
    {
        coords = Vector(-13865.797852, 2621.192871, 448.031250),
        label = "Station Shell hors ville",
        prefix = "de la"
    },
    {
        coords = Vector(-1164.874634, 2424.894531, 608.140320),
        label = "Cinéma",
        prefix = "du"
    },
    {
        coords = Vector(13177.087891, -7057.887695, 384.031250),
        label = "Châlets hors villes",
        prefix = "des"
    }
}